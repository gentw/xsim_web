...
<main>
    <section class="login-register-section paddingt-none online-store-sec">
        <div class="container">
            <div class="row">
                <div class="col-md-8">
                	<h1 class="yellow titleh3">BUY EUROPE SIM CARD ONLINE</h1>
                	@if(!$set_reload_amount)
	                    <div class="shadow-box form-step step1">
	                        ...
	                        <hr>
	                        <div class="card-btn-list" id="btn-selection">
	                        	<button class="theme-btn outlined @if($select_type == 'buy') active @endif" id="btn-select-buy">Buy XXSIM Card</button>
	                        	<button class="theme-btn outlined @if($select_type == 'recharge') active @endif" id="btn-select-reload">Recharge your XXSIM Card</button>
                        		<button class="theme-btn outlined @if($select_type == 'packages') active @endif" id="btn-select-data-plan">Buy a Data Plan</button>
	                        </div>
	                    ...
	                    <div id="data-packages-section">
	                    	<div class="shadow-box form-step package-step2 @if($select_type != 'packages') hide @endif"> <!-- hide -->
	                    	    <ul class="row list">
	                    	    	<li class="step-name col-sm-10 col-xs-9">Select Package Type</li>
	                    	    	<li class="text-right step-num col-sm-2 col-xs-3">02</li>
	                    	    </ul>
	                    	    <hr>
	                    	    <div class="card-btn-list text-center" id="btn-package-selection">
	                    	    	<button class="theme-btn outlined active" id="btn-select-zone-packages">Classic Package</button>
	                    	    	<button class="theme-btn outlined" id="btn-select-special-package">Special Package</button>
	                    	    </div>
	                    	</div>
		                    <div class="shadow-box form-step package-step3"> <!-- hide -->
		                        <ul class="row list zone-tab-list">
		                        	<li class="step-name col-sm-10 col-xs-9 paddingl-none">
		                        		<ul class="nav common-tabs zone-tabs">
											<li class="active"><a class="no-scroll-link" data-toggle="tab" href="#zone1">Zone A</a></li>
{{-- 											<li><a class="no-scroll-link" data-toggle="tab" href="#zone2">Zone 2</a></li>
 --}}											<li><a class="no-scroll-link" data-toggle="tab" href="#zone3">Zone B</a></li>
										</ul>
		                        	</li>
		                        	<li class="text-right step-num col-sm-2 col-xs-3">03</li>
		                        </ul>
		                        <!-- <hr class="margint-none"> -->
								<div class="tab-content">
									<div id="zone1" class="tab-pane fade in active">
										<div class="select-num">
					                        <div class="row">
					                        	<div class="col-sm-6">
					                        		<h4><b>Included Countries:</b></h4>
					                        	</div>
					                        	<div class="col-sm-6 text-right">
		                        					<button class="theme-btn dark-gray-btn btn-zone-selection" data-id="zone1">Im roaming in this zone</button>
					                        	</div>
					                        </div>
					                    </div>
										<ul class="zone-contry-list">
											@foreach($zones[0] as $country)
												<li>{{ $country }}</li>
											@endforeach
										</ul>
									</div>
									<div id="zone2" class="tab-pane fade">
										<div class="select-num">
					                        <div class="row">
					                        	<div class="col-sm-6">
					                        		<h4><b>Included Countries:</b></h4>
					                        		<p>Includes Zone A + Countries listed below</p>
					                        	</div>
					                        	<div class="col-sm-6 text-right">
		                        					<button class="theme-btn dark-gray-btn btn-zone-selection" data-id="zone2">Im roaming in this zone</button>
					                        	</div>
					                        </div>
					                    </div>
										<ul class="zone-contry-list">
											@foreach($zones[1] as $country)
												<li>{{ $country }}</li>
											@endforeach
										</ul>
									</div>
									<div id="zone3" class="tab-pane fade">
										<div class="select-num">
					                        <div class="row">
					                        	<div class="col-sm-6">
					                        		<h4><b>Included Countries:</b></h4>
					                        	...
					                        	<div class="col-sm-6 text-right">
		                        					<button class="theme-btn dark-gray-btn btn-zone-selection" data-id="zone3">Im roaming in this zone</button>
					                        	</div>
					                        </div>
					                    </div>
										<ul class="zone-contry-list">
											@foreach($zones[2] as $country)
												<li>{{ $country }}</li>
											@endforeach
										</ul>
									</div>
		                    ...
		                    <div class="shadow-box form-step package-step4 hide"> <!-- hide -->
		                        <ul class="row list">
		                        	<li class="step-name col-sm-10 col-xs-9">Data Packages</li>
		                        	<li class="text-right step-num col-sm-2 col-xs-3">03</li>
		                        </ul>
		                        <hr>
		                        @if(!Auth::guest())
			                        <div class="select-num">
				                        <div class="row">
				                        	...
				                        	<div class="col-sm-5">
				                        		<select id="change-card" class="custom" data-jcf='{"wrapNative": false, "wrapNativeOnMobile": false, "fakeDropInBody": false, "useCustomScroll": false}'>
			                    ...
			                    <div class="package-list">
				                    <div class="row hide" id="special-packages">
				                    	@foreach ($special_packages as $package)
				                    		<div class="col-sm-4">
				                    			<div class="package-item">
				                    				<div class="img-block">
			                       						<img alt="sim" src="{{ asset('front/images/std-sim.png') }}">
				                    				</div>
				                    				<h3>{{ $package->name }}</h3>
					                    			...
					                    			@endif
				                        			<button class="theme-btn active-packet" data-toggle="modal" data-target="#data-package" data-packetid="{{ $package->code }}">Purchase</button>
				                    				<p class="package-info">{{ $package->detail }}</p>
				                    			</div>
					                    	</div>
				                    	@endforeach
				                    </div>
				                    <div class="row hide" id="zone1-packages">
				                    	@foreach ($zone_packages[1] as $package)
				                    		<div class="col-sm-4">
				                    			<div class="package-item">
				                    				<div class="img-block">
			                       						<img alt="sim" src="{{ asset('front/images/std-sim.png') }}">
				                    ...
				                    <div class="row hide" id="zone2-packages">
				                    	@foreach ($zone_packages[2] as $package)
				                    		<div class="col-sm-4">
				                    			<div class="package-item">
				                    				<div class="img-block">
			                       						<img alt="sim" src="{{ asset('front/images/std-sim.png') }}">
				                    ...
				                    <div class="row hide" id="zone3-packages">
				                    	@foreach ($zone_packages[3] as $package)
				                    		<div class="col-sm-4">
				                    			<div class="package-item">
				                    				<div class="img-block">
			                       						<img alt="sim" src="{{ asset('front/images/std-sim.png') }}">
		                       	...
		                       	@if(Auth::guest())
									<div id="data-package" class="modal fade common-modal" role="dialog">
										<div class="modal-dialog">
											...
											<div class="modal-content">
												...
												<div class="modal-body">
													<h4>This functionality requires login, do you want to login ?<h4>
												</div>
												<div class="modal-footer text-center">
													<a href="javascript:;" class="theme-btn" data-dismiss="modal">Cancel</a>
									...
									<div id="data-package" class="modal fade common-modal" role="dialog">
										<div class="modal-dialog">
											...
											<div class="modal-content">
												...
												<div class="modal-body">
													<h4>Are you sure want to purchase this package?<h4>
												</div>
												<div class="modal-footer text-center">
													<a href="javascript:;" class="theme-btn" data-dismiss="modal">Cancel</a>
													<a href="javascript:;" class="theme-btn btn-confirm" data-dismiss="modal">Purchase</a>
												</div>
											</div>
										</div>
									</div>
	                    ...
	                    <div  id="buy_card" class="shadow-box form-step step2 @if($select_type != 'buy' && $select_type != 'recharge') hide @endif"> <!-- hide -->
	                        <ul class="row list">
	                        ...
	                        <hr>
	                       	<div class="row buy-section">
	                       		<div class="col-sm-12" >
	                       			<div class="row sim-data" id="sim1">
	                       				<div class="col-sm-5">
	                       					<img alt="sim" src="{{ asset('front/images/std-sim.png') }}" class="drop-shadow">
	                       					<div class="row middle">
	                       						<div class="col-sm-3">
	                       						</div>
	                       						<div class="col-sm-5 paddingl-none">
	                       							<div class="form-group">
					                                    <input type="number" min="0" placeholder="QTY" class="form-control qty-sim" name="qty-regular" id="qty-regular">
					                                </div>	                       							
	                       						</div>
	                       						<div class="col-sm-4 paddingl-none">
	                       							<h4 class="sim-rate">&euro; <span>12</span></h4>
	                       						</div>
	                       					</div>
	                       				</div>
	                       				<div class="col-sm-7 desc-block">
	                       					<h3>Standard XXSIM without Credit</h3>
	                       					<ul class="list-unstyled points">
	                       						<li>Triple cut SIM included (Standard, Micro, &amp; Nano)</li>
	                       						<li>Genuine UK &amp; US Number</li> <?php /* <li>Genuine UK, US &amp; Swiss Number</li>*/?>
	                       						<li>No Activation Needed. Ready to Use</li>
	                       						<li>Coverage of 200 Countries</li>
	                       						<li>Free Incoming Calls in 150 Countries</li>
	                       						<li>Free SMS ( XXSIM to XXSIM )</li>
	                       					</ul>
	                       				</div>
	                       			</div>
	                       			<!-- {{-- <div data-sim="regular" class="select-sim text-center">
	                       				<div class="data">
	                       					...
	                       					<h4 class="titleh4">Standard XXSIM without credit - &euro; 12</h4>
	                       				</div>
	                       			...
	                       			<div class="form-group">
	                                    <input type="number" min="0" class="form-control qty-sim" name="qty-regular" id="qty-regular" placeholder="QTY">
	                                </div> --}} -->
	                       		</div>
	                       		<div class="col-sm-12">
	                       			<div class="row sim-data" id="sim2">
	                       				<div class="col-sm-5">
	                       					<img alt="sim" src="{{ asset('front/images/credit-sim.png') }}" class="drop-shadow">
	                       					<div class="row middle">
	                       						<div class="col-sm-3">
	                       						</div>
	                       						<div class="col-sm-5 paddingl-none">
	                       							<div class="form-group">
					                                    <input type="number" min="0" class="form-control qty-sim" placeholder="QTY" name="qty-32" id="qty-32">
					                                </div>	                       							
	                       						</div>
	                       						<div class="col-sm-4 paddingl-none">
	                       							<h4 class="sim-rate">&euro; <span>32</span></h4>
	                       						</div>
	                       					</div>
	                       				</div>
	                       				<div class="col-sm-7 desc-block">
	                       					<h3>25% Off with EUR 25 Credit</h3>
	                       					<ul class="list-unstyled points">
	                       						<li>Triple cut SIM included (Standard, Micro, &amp; Nano)</li>
	                       						<li>Comes with EUR 25 Credit</li>
	                       						<li>Genuine UK &amp; US Number</li><?php /*<li>Genuine UK, US &amp; Swiss Number</li>*/ ?>
	                       						<li>No Activation Needed. Ready to Use</li>
	                       						<li>Coverage of 200 Countries</li>
	                       						<li>Free Incoming Calls in 150 Countries</li>
	                       			...
	                       			{{-- <div data-sim="regular" class="select-sim text-center">
	                       				<div class="data">
	                       					<img alt="sim" src="{{ asset('front/images/blue-sim.png') }}">
	                       					<h4 class="titleh4">25% off with &euro; 25 credit - &euro; 32</h4>
	                       				</div>
	                       				<div class="data-after">
	                       					<div class="inner">
	                       						<i class="fa fa-check"></i>
	                       			...
	                       			<div class="form-group">
	                                    <input type="number" min="0" class="form-control qty-sim" placeholder="QTY" name="qty-32" id="qty-32" placeholder="QTY">
	                                </div>  --}}
	                       		</div>
	                       		<div class="col-sm-12">
	                       			<div class="row sim-data" id="sim3">
	                       				<div class="col-sm-5">
	                       					<img alt="sim" src="{{ asset('front/images/free-sim.png') }}" class="drop-shadow">
	                       					<div class="row middle">
	                       						<div class="col-sm-3">
	                       						</div>
	                       						<div class="col-sm-5 paddingl-none">
	                       							<div class="form-group">
					                                    <input type="number" min="0" class="form-control qty-sim" placeholder="QTY" name="qty-50" id="qty-50">
					                                </div>	                       							
	                       						</div>
	                       						<div class="col-sm-4 paddingl-none">
	                       							<h4 class="sim-rate">&euro; <span>50</span></h4>
	                       						</div>
	                       					</div>
	                       				</div>
	                       				<div class="col-sm-7 desc-block">
	                       					<h3>FREE XXSIM with EUR 50 Credit</h3>
	                       					<ul class="list-unstyled points">
	                       						<li>Triple cut SIM included (Standard, Micro, &amp; Nano)</li>
	                       						<li>Comes with EUR 50 Credit</li>
	                       						<li>Genuine UK &amp; US Number</li><?php /*<li>Genuine UK, US &amp; Swiss Number</li>*/ ?>
	                       						<li>No Activation Needed. Ready to Use</li>
	                       						<li>Coverage of 200 Countries</li>
	                       						<li>Free Incoming Calls in 150 Countries</li>
	                       			...
	                       			{{-- <div data-sim="regular" class="select-sim text-center">
	                       				<div class="data">
	                       					<img alt="sim" src="{{ asset('front/images/blue-sim.png') }}">
	                       					<h4 class="titleh4">Free SIM with &euro; 50 credit - &euro; 50</h4>
	                       				</div>
	                       				<div class="data-after">
	                       					<div class="inner">
	                       						<i class="fa fa-check"></i>
	                       			...
	                       			<div class="form-group">
	                                    <input type="number" min="0" class="form-control qty-sim" placeholder="QTY" name="qty-50" id="qty-50" placeholder="QTY">
	                                </div>  --}}
	                       		</div>	     
	                       		<hr>                  		
	                       		<div class="col-sm-12">
	                       			<div class="total">
	                       				<div class="row">
	                       					<div class="col-xs-6"><h4 class="titleh4">Total</h4></div>
	                       					<div class="col-xs-6 text-right"><h3>&euro; <span id="sim-amount">0</span></h3></div>
	                       				</div>
	                       				<div class="row" id="discount-step-2">
                						</div>	                       				
	                       			</div>
	                       			<!-- <div class="form-group mobile-center text-right">
	                       		...
	                       		<div class="top-space">
	                        		...
	                        		<div class="coupon-div">
		                        		<form action="javascript:;" id="frmCardCoupon" role="form" class="form-inline">
											<div class="form-group">
		                                        <input type="text" name="coupon" id="coupon" class="form-control" placeholder="Coupon">
		                                    </div>									
											<button type="submit" id="btn-coupon" class="theme-btn">Apply</button>	
										</form>
									</div>
								</div>
								<div class="form-group mobile-center text-right">
	                        ...
	                        @if(Auth::guest())
								...
								<div class="new-account-form">
										...
										<div class="row">
											...
											<div class="col-sm-6">
												<div class="form-group">
			                                        <input type="text" name="company" id="company" class="form-control" placeholder="Company (optional)">
			                                    </div>
											</div>
											<div class="col-sm-6">
                    ...
                    <div class="shadow-box form-step step5 @if(!$set_reload_amount) hide @endif"> <!-- hide -->
                    	<ul class="row list">
                        	...
                        	<li class="text-right step-num col-sm-2 col-xs-3">@if(!$set_reload_amount) 04 @else 01 @endif</li>
                        </ul>
                    ...
                    <div class="shadow-box form-step step6 hide"> <!-- hide -->
                        <ul class="row list">
                        	...
                        	<li class="text-right step-num col-sm-2 col-xs-3">@if(!$set_reload_amount) 05 @else 02 @endif</li>
                        </ul>
...
<!-- Online Content End-->
                ...
                <form id="shoping-form" action="{{ route('make_payment') }}" method="post">
		    		...
		    		<input type="hidden" name="qty_32">
		    		<input type="hidden" name="qty_50">
                ...
                <form id="buy_regular_card" action="{{ route('buy_regular_card') }}" method="post">
                	{{ csrf_field() }}
		    		<input type="hidden" name="qty_regular">
		    		<input type="hidden" name="coupon_id">
		    		<input type="hidden" name="discount_amount">		    		
...
@push('scripts')
	...
	<script type="text/javascript">
		$(function(){
			...
			@if(!$set_reload_amount)
				switch_type("{{ $select_type }}");
				/**
				 * Next button action
				 */
				$(".btn-next").click(function(){
					if($(this).data('next') == 'step3' || $(this).data('next') == 'step5'){
						
						// if($("#qty-regular").val()>0)
							// $(".coupon-div").show();
						// else
							// $(".coupon-div").hide();
						
						if($("#sim-amount").html() == '0'){
							showMessage(204, 'Please enter QTY of at least one SIM type.');
							return false
						}
					}
					if($(this).data('next') == 'step3'){
						...
						// 	var data = {
						// 				'coupon' : $("#frmCardCoupon #coupon").val(),
						// 				'sim_amount' : parseInt($('#sim-amount').html()),
						// 				'qty_regular' : $("#qty-regular").val(),
						//                 'qty_32' : $("#qty-32").val(),
						//                 'qty_50' : $("#qty-50").val(),

						// 			};
						// 	apply_coupon(data, function(r){
						// 		console.log(r);
						// 	if(r.status == 200){
						// 		if(r.card_type){
						// 			$("#discount").html('<div class="col-sm-10 col-xs-7">Discount <br/>'+r.card_type+'</div><div class="col-sm-2 col-xs-5 price">-€ <span id="coupon_amount">'+r.coupon.discount_amount+'</span><input type="hidden" name="discount_amount" id="discount_amount" value="'+r.coupon.discount_amount+'"><input type="hidden" name="couponid" id="coupon_id" value="'+r.coupon.id+'"></div><hr>');
						// 		}else{
						// 			$("#discount").html('<div class="col-sm-10 col-xs-7">Discount</div><div class="col-sm-2 col-xs-5 price">-€ <span id="coupon_amount">'+r.coupon.discount_amount+'</span><input type="hidden" name="discount_amount" id="discount_amount" value="'+r.coupon.discount_amount+'"><input type="hidden" name="couponid" id="coupon_id" value="'+r.coupon.id+'"></div><hr>');
						// 		}
						// 		$("#discount-step-2").html('<div class="col-xs-6"><h4 class="titleh4">Discount</h4></div><div class="col-xs-6 text-right"><h3>-€ <span>'+r.coupon.discount_amount+'</span></h3></div>');
						// 		set_order_info();
						// 		// showMessage(r.status,r.message);
		    //                 }else{
		    //                 	$("#discount").html('');
		    //                 	$("#discount-step-2").html('');
		    //                 	set_order_info();
		    //                     // showMessage(r.status,r.message);
		    //                 }
						// });
						...
						if($("#btn-select-buy").hasClass('active')){
							// if($("#qty-regular").val()==1 && $("#qty-32").val()<=0 && $("#qty-50").val()<=0){
							// 	if($("#coupon_id").val()>=0){
							// 		$('.step6').addClass('hide');

							// 		var discount_amount = $('#discount_amount').val()==undefined?'':$('#discount_amount').val();
							// 		var coupon_id = $('#coupon_id').val()==undefined?'':$('#coupon_id').val();

							// 		$('#buy_regular_card input[name="qty_regular"]').val(1);
							// 		$('#buy_regular_card input[name="coupon_id"]').val(coupon_id);
							// 		$('#buy_regular_card input[name="qty_50"]').val(discount_amount);
							// 		$('#buy_regular_card').submit();

							// 		return false;
							// 	}								
							// }

							// if($("#qty-regular").val()>=1 && $("#coupon_id").val()>=0){
							if($("#coupon_id").val()>=0){
									$('.step6').addClass('hide');
									$.ajax({
								        url: '{{ route('used_coupon') }}',
								        type: 'POST',
								        dataType: 'json',
								        async: true,								       
								        data: {
				 ...
				 */
				 ...
				 $('[data-target="#login-modal"]').on({
				    focus: function () {
				        $(this).blur();
				    }
				}); 

				$('#btn-selection button').click(function(){
					var id = $(this).attr('id');
					if(id == 'btn-select-buy'){
						switch_type('buy');
						
					}
					else if(id == 'btn-select-reload'){
						switch_type('recharge');
						
					}
					else if(id == 'btn-select-data-plan'){
						switch_type('packages');
						
					}
					if(id != "" && id != undefined){
						var scroll_class = (id == "btn-select-data-plan" ? ".package-step2" : '.step2');
						$('#btn-selection button').removeClass('active');
						$(this).addClass('active');
						$(scroll_class).removeClass('hide');
						$('html, body').animate({
				...
				$(".qty-sim").change(function(){
					...
					var offer_32 = $('#qty-32').val() != '' ? $('#qty-32').val() : 0;
					var offer_50 = $('#qty-50').val() != '' ? $('#qty-50').val() : 0;

					if(regular_sim < 0 && offer_32 < 0 && offer_50 < 0){
						showMessage(412, "please enter minimum 1 QTY for regular SIM");
						$('#qty-regular').val('');
						$('#qty-32').val('');
						$('#qty-50').val('');
					}
					...
					if(regular_sim >= 0 || offer_32 >=0 || offer_50 >= 0){
						$("#sim-amount").html((parseInt(regular_sim) * 12) + (parseInt(offer_32) * 32) + (parseInt(offer_50) * 50));
					}
				});
				...
				/** 
				 * Packages section verification and scripts
				 */
				$('#btn-package-selection button').click(function(){
					var id = $(this).attr('id');
					var scroll_class = '';
					switch(id){
						case 'btn-select-zone-packages' :
							$('.package-step3').show();
							$('.package-step4').addClass('hide');
							$('.package-list .row').addClass('hide');
							scroll_class = ".package-step3";
							break;

						case 'btn-select-special-package' :
							$('.package-step3').hide();
							$('.package-step4 .step-num').html('03');
							$('.package-step4').removeClass('hide');
							$('.package-list .row').addClass('hide');
							$('.package-list #special-packages').removeClass('hide');
							scroll_class = ".package-step4";
							break;
					}
					$('#btn-package-selection button').removeClass('active');
					$(this).addClass('active');
					if(scroll_class != ''){
						$('html, body').animate({
							scrollTop: $(scroll_class).offset().top
				...
				$('.zone-tabs li').click(function(){
					$('.package-step4').addClass('hide');
					$('.package-list .row').addClass('hide');
				});

				$('.btn-zone-selection').click(function(){
					$('.package-list .row').addClass('hide');
					$('.package-step4 .step-num').html('04');
					$('.package-step4').removeClass('hide');
					$('.package-list #'+ $(this).data('id') + '-packages').removeClass('hide');
					$('html, body').animate({
						scrollTop: $('.package-step4').offset().top
					}, 'slow');
				});

				$(document).on('click', '.active-packet', function(){
			        $("#data-package .btn-confirm").attr('data-packetid', $(this).data('packetid'));
			        // $("#data-package").modal("show");
			    });

			    $("#data-package").on('hide.bs.modal', function () {
			        $("#data-package .btn-confirm").removeAttr('data-packetid');
			    });

			    $("#data-package .btn-confirm").click(function(){
			    	if($('#change-card').val() == null || $('#change-card').val() == undefined || $('#change-card').val() == ''){
			    		showMessage(412, "Please select card number");
			    	}
			    	else{
				...
				$('#frmCardCoupon').validate({
		            ...
		            messages: {
		                coupon: {
		                    required: "@lang('validation.required', ['attribute'=>'coupon'])"
		                }
		            },

		            invalidHandler: function (event, validator) { //display error alert on form submit
		                $('.alert-danger', $('#frmCardCoupon')).show();
		                $('#frmCardCoupon').addClass('form-error');
		            },
			...
			$('#frmCardPayment').submit(function(){
				...
				if($(this).valid()){
					var qty_regular = $('#qty-regular').val();
					var qty_32 = $('#qty-32').val();
					var qty_50 = $('#qty-50').val();
					...
					if((qty_regular == '' || qty_regular == null || qty_regular == undefined) && (qty_32 == '' || qty_32 == null || qty_32 == undefined) && (qty_50 == '' || qty_50 == null || qty_50 == undefined) && (reload_amount == '' || reload_amount == null || reload_amount == undefined || reload_number == '' || reload_number == null || reload_number == undefined)){
						showMessage(412, "Something went wrong! Please try again later");
						return false;
					}
					else{
						var expire = $('#frmCardPayment input[name="expire"]').val().split('/');
						$('#shoping-form input[name="qty_regular"]').val(qty_regular);
						$('#shoping-form input[name="qty_32"]').val(qty_32);
						$('#shoping-form input[name="qty_50"]').val(qty_50);
						$('#shoping-form input[name="reload_amount"]').val(reload_amount);
						$('#shoping-form input[name="reload_number"]').val(reload_number);
						$('#shoping-form input[name="coupon_id"]').val(coupon_id);
						$('#shoping-form input[name="discount_amount"]').val(discount_amount);						
				...
				$.ajax({
			        ...
			        success: function(r){
			        	if(r.status == 200){
			        		...
			        		$('#paypal_payment_form #paypal_item_amount').val(data.item_price-data.discount_amount);
		    ...
		    function switch_type(select_type){
				switch(select_type) {
					case "buy":
						$('.step2').show();
						$('.reload-section').hide();
						$('#data-packages-section').hide();
						$('.buy-section').show();
			...
			function set_order_info() {
				...
				var offer_32 = $("#qty-32").val();
				var offer_50 = $("#qty-50").val();
				if(regular_sim != ''){
					$(".order-list-body ul ").append(`<li>
									<div class="row">
										<div class="col-sm-8 col-xs-7">
										Standard XXSIM without credit - &euro; 12
										</div>
										<div class="col-sm-2 col-xs-2">
											`+regular_sim+`
										</div>
				...
				if(offer_32 != ''){
					$(".order-list-body ul ").append(`<li>
									<div class="row">
										<div class="col-sm-8 col-xs-7">
										25% off with EUR 25 credit - &euro; 32
										</div>
										<div class="col-sm-2 col-xs-2">
											`+offer_32+`
										</div>
										<div class="col-sm-2 col-xs-3 price">
											&euro; `+ (32 * parseInt(offer_32)) +`
										</div>
									</div>
								</li>`);
				}
				if(offer_50 != ''){
					$(".order-list-body ul ").append(`<li>
									<div class="row">
										<div class="col-sm-8 col-xs-7">
										Free XXSIM with EUR 50 credit - &euro; 50
										</div>
										<div class="col-sm-2 col-xs-2">
											`+offer_50+`
										</div>
										<div class="col-sm-2 col-xs-3 price">
											&euro; `+ (50 * parseInt(offer_50)) +`
										</div>
									</div>
								</li>`);
				}
				if($('#discount_amount').val()>0)
					$('#total_amount').html(parseInt($('#sim-amount').html())-parseInt($('#discount_amount').val()));
				else 
