        ...
        <article class="container">
            ...
            <ul class="list-unstyled">
                ...
                <li>
                    ...
                    <p>After dialing the national prefix you can call any XXSIM for free if you use the green number. It does not matter in which country the other XXSIM is. When making a free call with the green number, EUR0.15/min will be charged to the other XXSIM and the caller number will be displayed with the prefix 999. Eg. Someone in the US wants to call another XXSIM in the United Arab Emirates. If he/she uses the green number, the call will be charged to the call recipient who will have tp pay EUR0.15/min. The caller in the US will not be charged for the call.</p>
                </li>
                <li>
                        ...
                        <div class="table-responsive">
                            <table style="width: 670px; border: 0;">
                                <tbody>
                                    ...
                                    <tr>
                                        <td>Data Package 1, Code 29</td><td>10MB, 1 day, EUR1.40</td>
                                    </tr>
                                    <tr>
                                        <td>Data Package 2, Code 30</td><td>50MB, 1 day, EUR5.50</td>
                                    </tr>
                                    <tr>
                                        <td>Data Package 3, Code 31</td><td>150MB, 7 days, EUR15.00</td>
                                    </tr>
                                    <tr>
                                        <td>Data Package 4, Code 32</td><td>250MB, 14 days, EUR24.00</td>
                                    </tr>
                                    <tr>
                                        <td>Data Package 5, Code 33</td><td>500MB, 30 days, EUR45.00</td>
                                    </tr>
                                    <tr>
                                        <td>Data Package 6, Code 34</td><td>1000MB, 30 days, EUR89.00</td>
                                    </tr>
                                    <tr>
                                        <td>Data Package 7, Code 35</td><td>2000MB, 30 days, EUR169.00</td>
                                    </tr>
                                    <tr>
                                        ...
                                        <tr>
                                           <td>***Zone B : Countries zone A  Anguilla, Antigua-and-Barbuda, Aruba, Barbados, Bermuda, Brazil, British Virgin Islands, Cayman Islands, Dominica, Ecuador, Egypt, Grenada, Haiti, India, Jamaica, Japan, Kuwait, Macau, Macedonia, Moldova, Nepal, Netherlands Antilles, New Zealand, Nigeria, Qatar,  Serbia, Sri Lanka, St.Kitts, St Lucia
                                    </tr>
                                </tbody>
                            </table>
                        </div>
