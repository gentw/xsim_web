                	...
                	@if(!$set_reload_amount)
	                    <div class="shadow-box form-step step1">
	                        ...
	                        <div class="card-btn-list" id="btn-selection">
	                        	...
	                        	@if(Auth::guest())
	                        		<button class="theme-btn outlined" data-toggle="modal" data-target="#login-modal">Buy a Data Plan</button>
	                        	@else
	                        ...
	                        {{-- <div class="row check-list">
	                       	...
	                       	@if(Auth::guest())
								<div id="login-modal" class="modal fade common-modal" role="dialog">
		                ...
		                @endif
	                    <div class="shadow-box form-step step2 @if($select_type != 'buy' && $select_type != 'recharge') hide @endif"> <!-- hide -->
	                        <ul class="row list">
	                        ...
	                        <hr>
	                       	<div class="row buy-section">
	                       			...
	                       			<div class="row sim-data">
	                       					...
	                       					<div class="row middle">
	                       						...
	                       						<div class="col-sm-5 paddingl-none">
	                       							<div class="form-group">
					                                    <input type="number" min="0" class="form-control qty-sim" name="qty-regular" id="qty-regular">
					                                </div>	                       							
	                       						</div>
	                       				...
	                       				<div class="col-sm-7 desc-block">
	                       					...
	                       					<ul class="list-unstyled points">
	                       						...
	                       						<li>Genuine UK, US &amp; Swiss Number</li>
	                       		...
	                       		<div class="col-sm-12">
	                       			<div class="row sim-data">
	                       				<div class="col-sm-5">
	                       					...
	                       					<div class="row middle">
	                       						...
	                       						<div class="col-sm-5 paddingl-none">
	                       							<div class="form-group">
					                                    <input type="number" min="0" class="form-control qty-sim" name="qty-32" id="qty-32">
					                                </div>	                       							
	                       						</div>
	                       						<div class="col-sm-4 paddingl-none">
	                       			...
	                       			<div class="form-group">
	                                    <input type="number" min="0" class="form-control qty-sim" name="qty-32" id="qty-32" placeholder="Quantity">
	                                </div>  --}}
	                       		</div>
	                       		<div class="col-sm-12">
	                       			<div class="row sim-data">
	                       				<div class="col-sm-5">
	                       					...
	                       					<div class="row middle">
	                       						...
	                       						<div class="col-sm-5 paddingl-none">
	                       							<div class="form-group">
					                                    <input type="number" min="0" class="form-control qty-sim" name="qty-50" id="qty-50">
					                                </div>	                       							
	                       						</div>
	                       						<div class="col-sm-4 paddingl-none">
	                       			...
	                       			<div class="form-group">
	                                    <input type="number" min="0" class="form-control qty-sim" name="qty-50" id="qty-50" placeholder="Quantity">
	                                </div>  --}}
	                       		</div>	     
	                       		<hr>                  		
	                       		<div class="col-sm-12">
			...
			@if(!$set_reload_amount)
				...
				$(".qty-sim").change(function(){
					...
					if(regular_sim < 0 && offer_32 < 0 && offer_50 < 0){
						showMessage(412, "please enter minimum 1 quantity for regular SIM");
						$('#qty-regular').val('');
						$('#qty-32').val('');
						$('#qty-50').val('');
					}
