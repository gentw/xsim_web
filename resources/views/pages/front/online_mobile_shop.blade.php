            ...
            <div class="row">
                <div class="col-md-8">
                	@if(!$set_reload_amount)
		                        ...
		                        <ul class="row list zone-tab-list">
		                        	<li class="step-name col-sm-10 col-xs-9 paddingl-none">
		                        		<ul class="nav common-tabs zone-tabs">
											<li class="active"><a class="no-scroll-link" data-toggle="tab" href="#zone1">Zone 1</a></li>
											<li><a class="no-scroll-link" data-toggle="tab" href="#zone2">Zone 2</a></li>
											<li><a class="no-scroll-link" data-toggle="tab" href="#zone3">Zone 3</a></li>
										</ul>
		                        	</li>
									...
									<div id="zone2" class="tab-pane fade">
										<div class="select-num">
					                        <div class="row">
					                        	<div class="col-sm-6">
					                        		<h4><b>Included Countries:</b></h4>
					                        		<p>Includes Zone 1 + Countries listed below</p>
					                        	</div>
					                        	<div class="col-sm-6 text-right">
									...
									<div id="zone3" class="tab-pane fade">
										<div class="select-num">
					                        <div class="row">
					                        	<div class="col-sm-6">
					                        		<h4><b>Included Countries:</b></h4>
					                        		<p>Includes Zone 1 + Zone 2 + Countries listed below</p>
					                        	</div>
					                        	<div class="col-sm-6 text-right">
	                    ...
	                    <div  id="myDiv" class="shadow-box form-step step2 @if($select_type != 'buy' && $select_type != 'recharge') hide @endif"> <!-- hide -->
	                        <ul class="row list">
				...
				$("#btn-coupon").click(function(){
					if($('#frmCardCoupon').valid()){						
						...
						apply_coupon(data, function(r){
							if(r.status == 200){
								$("#discount").html('<div class="col-sm-10 col-xs-7">Discount</div><div class="col-sm-2 col-xs-5 price">-€ <span id="coupon_amount">'+r.coupon.discount_amount+'</span><input type="hidden" name="discount_amount" id="discount_amount" value="'+r.coupon.discount_amount+'"><input type="hidden" name="couponid" id="coupon_id" value="'+r.coupon.id+'"></div>');
								$("#discount-step-2").html('<div class="col-xs-6"><h4 class="titleh4">Discount</h4></div><div class="col-xs-6 text-right"><h3><span>'+r.coupon.discount_percentage+' %</span></h3></div>');
								set_order_info();
								showMessage(r.status,r.message);
		                    }else{
		                    	$("#discount").html('');
