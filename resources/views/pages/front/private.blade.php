                ...
                <div class="col-sm-6 desc-block">
                    <div>
                        <ul>
                            ...
                            <li>LTE/3G/GPRS from €0.19/MB or packages, no minimal charge in most countries</li>
            ...
            <div class="feature feature2">
                <div class="row">
                    ...
                    <div class="col-sm-6 col-sm-pull-6 col-xs-12">
                        <div class="desc">
                            <h3>What if I want to browse the internet <br/> and stay connected to social media?</h3>
