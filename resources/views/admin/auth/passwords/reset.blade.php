...
<!--<![endif]-->
    ...
    <body class="login">
        ...
        <div class="content">
            ...
            @endif
            <!-- BEGIN LOGIN FORM -->
            <form class="login-form" id="frmReset" role="form" method="POST" action="{{ url('admin/password/reset') }}">
                {{ csrf_field() }}
                ...
                <div class="form-group{{ $errors->has('email') ? ' has-error' : '' }}">
                    ...
                    <div class="input-icon">
                        ...
                        <input class="form-control placeholder-no-fix" id="email" type="email" name="email" value="{{$email or old('email') }}" placeholder="E-Mail Address" autofocus /> 
                        @if ($errors->has('email'))
                ...
                <div class="form-group{{ $errors->has('password_confirmation') ? ' has-error' : '' }}">
                    ...
                    <div class="input-icon">
                        <i class="fa fa-lock"></i>
                        <input class="form-control placeholder-no-fix" type="password" autocomplete="off" placeholder="Confirm Password" name="password_confirmation" id="password-confirm" /> 
