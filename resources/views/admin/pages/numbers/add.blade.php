    ...
    <div class="col-md-12">
        ...
        <div class="portlet light bordered">
            ...
            <div class="portlet-body">
                <form id="frmstore" class="form-horizontal" role="form" method="POST" action="{{ route('admin.number.store') }}" enctype="multipart/form-data">
                    {{ csrf_field() }}
                    <div class="form-group{{ $errors->has('country') ? ' has-error' : '' }}">
                        ...
                        <div class="col-md-4">
                            <div class="input-icon">
                                ...
                                <input type="text" class="form-control" name="country" id="country" placeholder="Enter Country" maxlength="230" value="{{ old('country','') }}">
                    ...
                    <div class="form-group{{ $errors->has('number') ? ' has-error' : '' }}">
                        ...
                        <div class="col-md-4">
                            <div class="input-icon">
                                <i class="fa fa-phone"></i>
                                <input type="text" class="form-control" name="number" id="number" placeholder="Enter Number" maxlength="15" value="{{ old('number','') }}">
                    ...
                    <div class="form-group{{ $errors->has('setup_fee') ? ' has-error' : '' }}">
                        ...
                        <div class="col-md-4">
                            <div class="input-icon">
                                ...
                                <input type="text" class="form-control" name="setup_fee" id="setup_fee" placeholder="Enter Setup Fee" value="{{ old('setup_fee','') }}">
                    ...
                    <div class="form-group{{ $errors->has('monthly_fee') ? ' has-error' : '' }}">
                        ...
                        <div class="col-md-4">
                            <div class="input-icon">
                                <i class="fa fa-money"></i>
                                <input type="text" class="form-control" name="monthly_fee" id="monthly_fee" placeholder="Enter Monthly Fee" value="{{ old('monthly_fee','') }}">
