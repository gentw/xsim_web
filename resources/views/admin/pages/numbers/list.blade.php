        ...
        <div class="portlet light portlet-fit portlet-datatable bordered">
            <div class="portlet-title">
                <div class="caption">
                    ...
                    <span class="caption-subject font-green sbold uppercase">Manage National Numbers</span>
                </div>
                <div class="tools"> 
                ...
                <div class="actions">
                    @if (in_array('add', $permissions))
                        <a href="{{ route('admin.number.create') }}" data-toggle="tooltip" title="Add National Number" class="btn btn-circle green"> Add
                            <i class="fa fa-plus"></i>
                        </a>
                        <a href="javascript:;" id="btn-import" class="btn btn-circle blue">Import <i class = "fa fa-upload"></i></a>
                        <form action="{{ route('admin.number.import') }}" id="import_form" method="POST" enctype="multipart/form-data">
                            {{ csrf_field() }}
             ...
             @if (in_array('delete', $permissions))
                <a href="{{ route('admin.number.destroy',0) }}" name="del_select" id="del_select" class="btn btn-sm btn-danger delete_all_link">Delete Selected</a>
            @endif
    ...
    $(function(){
         oTable = $("#table_DT").dataTable({
            ...
            "columns": [
                ...
                { "title": "Setup Fee" ,"data": "setup_fee" },
                { "title": "Allocated" ,"data": "allocated", searchble: false},
            ...
            "pageLength": 10,
            "ajax": {
                "url": "{{route('admin.number.listing')}}", // ajax source
            },
