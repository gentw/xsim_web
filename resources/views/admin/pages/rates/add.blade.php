        ...
        <div class="portlet light bordered">
            <div class="portlet-title">
                <div class="caption">
                    ...
                    <span class="caption-subject font-green sbold uppercase">Add Call rate</span>
                </div>
            </div>
            <div class="portlet-body">
                <form id="frmstore" class="form-horizontal" role="form" method="POST" action="{{ route('admin.rate.store') }}" enctype="multipart/form-data">
                    {{ csrf_field() }}
                    <div class="form-group{{ $errors->has('carrier') ? ' has-error' : '' }}">
                        ...
                        <div class="col-md-4">
                            <div class="input-icon">
                                ...
                                <input type="text" class="form-control" name="carrier" id="carrier" placeholder="Enter Carrier" maxlength="255" value="{{ old('carrier','') }}">
                    ...
                    <div class="form-group{{ $errors->has('operator') ? ' has-error' : '' }}">
                        ...
                        <div class="col-md-4">
                            <div class="input-icon">
                                <i class="fa fa-font"></i>
                                <input type="text" class="form-control" name="operator" id="operator" placeholder="Enter Operator" maxlength="255" value="{{ old('operator','') }}">
                    ...
                    <div class="form-group{{ $errors->has('network_type') ? ' has-error' : '' }}">
                        ...
                        <div class="col-md-4">
                            <div class="input-icon">
                                <i class="fa fa-font"></i>
                                <input type="text" class="form-control" name="network_type" id="network_type" placeholder="Enter Network Type" maxlength="255" value="{{ old('network_type','') }}">
                    ...
                    <div class="form-group{{ $errors->has('network') ? ' has-error' : '' }}">
                        ...
                        <div class="col-md-4">
                            <div class="input-icon">
                                <i class="fa fa-font"></i>
                                <input type="text" class="form-control" name="network" id="network" placeholder="Enter Network" maxlength="255" value="{{ old('network','') }}">
                    ...
                    <div class="form-group{{ $errors->has('abbreviation') ? ' has-error' : '' }}">
                        ...
                        <div class="col-md-4">
                            <div class="input-icon">
                                <i class="fa fa-font"></i>
                                <input type="text" class="form-control" name="abbreviation" id="abbreviation" placeholder="Enter Abbreviation" maxlength="255" value="{{ old('abbreviation','') }}">
                    ...
                    <div class="form-group{{ $errors->has('code') ? ' has-error' : '' }}">
                        ...
                        <div class="col-md-4">
                            <div class="input-icon">
                                <i class="fa fa-font"></i>
                                <input type="text" class="form-control" name="code" id="code" placeholder="Enter Code" maxlength="255" value="{{ old('code','') }}">
                                @if ($errors->has('code'))
                                    <span class="help-block">
                    ...
                    <div class="form-group{{ $errors->has('link_1') ? ' has-error' : '' }}">
                        ...
                        <div class="col-md-4">
                            <div class="input-icon">
                                ...
                                <input type="text" class="form-control" name="link_1" id="link_1" placeholder="Enter Link" maxlength="255" value="{{ old('link_1','') }}">
                    ...
                    <div class="form-group{{ $errors->has('link_2') ? ' has-error' : '' }}">
                        ...
                        <div class="col-md-4">
                            <div class="input-icon">
                                <i class="fa fa-external-link"></i>
                                <input type="text" class="form-control" name="link_2" id="link_2" placeholder="Enter Link" maxlength="255" value="{{ old('link_2','') }}">
                    ...
                    <div class="form-group{{ $errors->has('link_3') ? ' has-error' : '' }}">
                        ...
                        <div class="col-md-4">
                            <div class="input-icon">
                                <i class="fa fa-external-link"></i>
                                <input type="text" class="form-control" name="link_3" id="link_3" placeholder="Enter Link" maxlength="255" value="{{ old('link_3','') }}">
                    ...
                    <div class="form-group{{ $errors->has('sms_in_rate') ? ' has-error' : '' }}">
                        ...
                        <div class="col-md-4">
                            <div class="input-icon">
                                <i class="fa fa-money"></i>
                                <input type="text" class="form-control" name="sms_in_rate" id="sms_in_rate" placeholder="Enter Incoming SMS rate" value="{{ old('sms_in_rate') }}">
                    ...
                    <div class="form-group{{ $errors->has('sms_out_rate') ? ' has-error' : '' }}">
                        ...
                        <div class="col-md-4">
                            <div class="input-icon">
                                <i class="fa fa-money"></i>
                                <input type="text" class="form-control" name="sms_out_rate" id="sms_out_rate" placeholder="Enter Outgoing SMS rate" value="{{ old('sms_out_rate') }}">
                    ...
                    <div class="form-group{{ $errors->has('xxsim_sms_rate') ? ' has-error' : '' }}">
                        ...
                        <div class="col-md-4">
                            <div class="input-icon">
                                <i class="fa fa-money"></i>
                                <input type="text" class="form-control" name="xxsim_sms_rate" id="xxsim_sms_rate" placeholder="Enter XXSim SMS rate" value="{{ old('xxsim_sms_rate') }}">
                    ...
                    <div class="form-group{{ $errors->has('zone') ? ' has-error' : '' }}">
                        ...
                        <div class="col-md-4">
                            <div class="input-icon">
                                ...
                                <input type="text" class="form-control" name="zone" id="zone" placeholder="Enter Zone" value="{{ old('zone') }}">
                                @if ($errors->has('zone'))
                                    <span class="help-block">
                    ...
                    <div class="form-group{{ $errors->has('zone_rate') ? ' has-error' : '' }}">
                        ...
                        <div class="col-md-4">
                            <div class="input-icon">
                                <i class="fa fa-money"></i>
                                <input type="text" class="form-control" name="zone_rate" id="zone_rate" placeholder="Enter Zone rate" value="{{ old('zone_rate') }}">
                    ...
                    <div class="form-group{{ $errors->has('gprs_rate') ? ' has-error' : '' }}">
                        ...
                        <div class="col-md-4">
                            <div class="input-icon">
                                <i class="fa fa-money"></i>
                                <input type="text" class="form-control" name="gprs_rate" id="gprs_rate" placeholder="Enter GPRS rate" value="{{ old('gprs_rate') }}">
                    ...
                    <div class="form-group{{ $errors->has('call_in_rate') ? ' has-error' : '' }}">
                        ...
                        <div class="col-md-4">
                            <div class="input-icon">
                                <i class="fa fa-money"></i>
                                <input type="text" class="form-control" name="call_in_rate" id="call_in_rate" placeholder="Enter Incoming call rate" value="{{ old('call_in_rate') }}">
                    ...
                    <div class="form-group{{ $errors->has('call_out_rate') ? ' has-error' : '' }}">
                        ...
                        <div class="col-md-4">
                            <div class="input-icon">
                                <i class="fa fa-money"></i>
                                <input type="text" class="form-control" name="call_out_rate" id="call_out_rate" placeholder="Enter Outgoing call rate" value="{{ old('call_out_rate') }}">
                    ...
                    <div class="form-group{{ $errors->has('extra_rate') ? ' has-error' : '' }}">
                        ...
                        <div class="col-md-4">
                            <div class="input-icon">
                                <i class="fa fa-money"></i>
                                <input type="text" class="form-control" name="extra_rate" id="extra_rate" placeholder="Enter Extra rate" value="{{ old('extra_rate') }}">
                    ...
                    <div class="form-group{{ $errors->has('xxsim_call_rate') ? ' has-error' : '' }}">
                        ...
                        <div class="col-md-4">
                            <div class="input-icon">
                                <i class="fa fa-money"></i>
                                <input type="text" class="form-control" name="xxsim_call_rate" id="xxsim_call_rate" placeholder="Enter XXSim call rate" value="{{ old('xxsim_call_rate') }}">
                    ...
                    <div class="form-group{{ $errors->has('call_xxsim_to_xxsim') ? ' has-error' : '' }}">
                        ...
                        <div class="col-md-4">
                            <div class="input-icon">
                                <i class="fa fa-money"></i>
                                <input type="text" class="form-control" name="call_xxsim_to_xxsim" id="call_xxsim_to_xxsim" placeholder="Enter XXSim to XXSim call rate" value="{{ old('call_xxsim_to_xxsim') }}">
                    ...
                    <div class="form-group{{ $errors->has('sms_xxsim_to_xxsim') ? ' has-error' : '' }}">
                        ...
                        <div class="col-md-4">
                            <div class="input-icon">
                                <i class="fa fa-money"></i>
                                <input type="text" class="form-control" name="sms_xxsim_to_xxsim" id="sms_xxsim_to_xxsim" placeholder="Enter XXSim to XXSim SMS rate" value="{{ old('sms_xxsim_to_xxsim') }}">
                    ...
                    <div class="form-group{{ $errors->has('voicemail') ? ' has-error' : '' }}">
                        ...
                        <div class="col-md-4">
                            <div class="input-icon">
                                <i class="fa fa-money"></i>
                                <input type="text" class="form-control" name="voicemail" id="voicemail" placeholder="Enter Voicemail rate" value="{{ old('voicemail') }}">
                    ...
                    <div class="form-group{{ $errors->has('comment') ? ' has-error' : '' }}">
                        ...
                        <div class="col-md-4">
                            <div class="input-icon">
                                ...
                                <textarea class="form-control" name="comment" id="comment" placeholder="Enter comment..." rows="5">{{ old('comment') }}</textarea>
