...
@section('breadcrumb')
{!! Breadcrumbs::render('group_reload') !!}
@endsection
        ...
        <div class="portlet light portlet-fit portlet-datatable bordered">
            <div class="portlet-title">
                <div class="caption">
                    ...
                    <span class="caption-subject font-green sbold uppercase">Manage Group Reload</span>
                </div>
                <div class="tools">
                ...
                <div class="actions">
                    @if (in_array('add', $permissions))
                        <a href="{{ route('admin.group-reload.create') }}" data-toggle="tooltip" title="Add Card Order" class="btn btn-circle green"> Add
             ...
             @if (in_array('delete', $permissions))
                <a href="{{ route('admin.group-reload.destroy',0) }}" name="del_select" id="del_select" class="btn btn-sm btn-danger delete_all_link">Delete Selected</a>
            @endif
...
<script type="text/javascript">
    ...
    $(function(){
         oTable = $("#table_DT").dataTable({
            ...
            "pageLength": 10,
            "ajax": {
                "url": "{{route('admin.group-reload.listing')}}", // ajax source
            },
