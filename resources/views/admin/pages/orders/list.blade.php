        ...
        <div class="portlet light portlet-fit portlet-datatable bordered">
            <div class="portlet-title">
                <div class="caption">
                    ...
                    <span class="caption-subject font-green sbold uppercase">Manage Card Orders</span>
                </div>
                <div class="tools">
                ...
                <div class="actions">
                    @if (in_array('add', $permissions))
                        <a href="{{ route('admin.order.create') }}" data-toggle="tooltip" title="Add Card Order" class="btn btn-circle green"> Add
             ...
             @if (in_array('delete', $permissions))
                <a href="{{ route('admin.order.destroy',0) }}" name="del_select" id="del_select" class="btn btn-sm btn-danger delete_all_link">Delete Selected</a>
            @endif
    ...
    $(function(){
         oTable = $("#table_DT").dataTable({
            ...
            "columns": [
                ...
                { "title": "Regualr Sim Quantities" ,"data": "qty_regular" },
                { "title": "25% off Sim Quantities" ,"data": "qty_32" },
                { "title": "Free Sim Quantities" ,"data": "qty_50" },
                { "title": "Order Id" ,"data": "order_number" },
