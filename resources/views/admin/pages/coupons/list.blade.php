        ...
        <div class="portlet light portlet-fit portlet-datatable bordered">
            <div class="portlet-title">
                <div class="caption">
                    ...
                    <span class="caption-subject font-green sbold uppercase">Manage Coupon Page</span>
                </div>
                <div class="tools"> 
                ...
                <div class="actions">
                    @if (in_array('add', $permissions))
                        <a href="{{ route('admin.coupons.create') }}" data-toggle="tooltip" title="Add Coupon" class="btn btn-circle green"> Add
             ...
             @if (in_array('delete', $permissions))
                <a href="{{ route('admin.coupons.destroy',0) }}" name="del_select" id="del_select" class="btn btn-sm btn-danger delete_all_link">Delete Selected</a>
            @endif
    ...
    $(function(){
         oTable = $("#table_DT").dataTable({
            ...
            "columns": [
                ...
                { "title": "Min. Order Amount ( € )" ,"data": "min_order_amount" },
                { "title": "Card Types" ,"data": "card_type_id" },
            ...
            "pageLength": 10,
            "ajax": {
                "url": "{{route('admin.coupons.listing')}}", // ajax source
            },
