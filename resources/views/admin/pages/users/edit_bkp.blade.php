        ...
        <div class="portlet light bordered">
            <div class="portlet-title">
                <div class="caption">
                    ...
                    <span class="caption-subject font-green sbold uppercase">Edit User</span>
                </div>
            </div>
            <div class="portlet-body">
                <form id="frmstore" class="form-horizontal" role="form" method="POST" action="{{ route('admin.user.update', $user->id) }}" enctype="multipart/form-data">
                    {{ csrf_field() }}
                    {{ method_field('PUT') }}
                    ...
                    <div class="form-group{{ $errors->has('name') ? ' has-error' : '' }}">
                        <label for="name" class="col-md-2 control-label">User Name{!! $mend_sign !!}</label>
                        <div class="col-md-4">
                            <div class="input-icon">
                                <i class="fa fa-user"></i>
                                <input type="text" class="form-control" name="name" id="name" placeholder="Enter User Name" maxlength="50" value="{{ old('name', $user->name) }}">
                                @if ($errors->has('name'))
                                    <span class="help-block">
                    ...
                    <div class="form-group{{ $errors->has('surname') ? ' has-error' : '' }}">
                        <label for="surname" class="col-md-2 control-label">User Surname{!! $mend_sign !!}</label>
                        <div class="col-md-4">
                            <div class="input-icon">
                                <i class="fa fa-user"></i>
                                <input type="text" class="form-control" name="surname" id="surname" placeholder="Enter User Name" maxlength="50" value="{{ old('surname', $user->surname) }}">
                    ...
                    <div class="form-group{{ $errors->has('phone') ? ' has-error' : '' }}">
                        ...
                        <div class="col-md-4">
                            <div class="input-icon">
                                ...
                                <input type="text" placeholder="Enter Contact No" name="phone" id="phone" class="form-control" value="{{old('phone', $user->phone)}}" maxlength="15" />
                                @if ($errors->has('phone'))
                                    <span class="help-block">
                    ...
                    <div class="form-group{{ $errors->has('mobile') ? ' has-error' : '' }}">
                        ...
                        <div class="col-md-4">
                            <div class="input-icon">
                                ...
                                <input type="text" placeholder="Enter Phone No" name="mobile" id="mobile" class="form-control" value="{{old('mobile', $user->mobile)}}" maxlength="15" />
                    ...
                    <div class="form-group{{ $errors->has('dob') ? ' has-error' : '' }}">
                        ...
                        <div class="col-md-4">
                            <div class="input-icon">
                                ...
                                <input type="text" placeholder="Enter Date Of Birth" name="dob" id="dob" class="form-control" value="{{old('dob', $user->dob)}}" readonly />
                                @if ($errors->has('dob'))
                                    <span class="help-block">
                    ...
                    <div class="form-group{{ $errors->has('address') ? ' has-error' : '' }}">
                        ...
                        <div class="col-md-4">
                            <div class="input-icon">
                                ...
                                <input type="text" placeholder="Enter Address" name="address" id="address" class="form-control" value="{{old('address', $user->address)}}" />
                    ...
                    <div class="form-group{{ $errors->has('zip_code') ? ' has-error' : '' }}">
                        <label for="zip_code" class="col-md-2 control-label">Zip code{!! $mend_sign !!}</label>
                        <div class="col-md-4">
                            <div class="input-icon">
                                <i class="fa fa-street-view"></i>
                                <input type="text" placeholder="Enter Zip Code" name="zip_code" id="zip_code" class="form-control" value="{{old('zip_code', $user->zip_code)}}" maxlength="15" />
                    ...
                    <div class="form-group{{ $errors->has('city') ? ' has-error' : '' }}">
                        ...
                        <div class="col-md-4">
                            <div class="input-icon">
                                ...
                                <input type="text" placeholder="Enter City" name="city" id="city" class="form-control" value="{{old('city', $user->city)}}" />
                                @if ($errors->has('city'))
                                    <span class="help-block">
                        ...
                        <div class="col-md-4">
                            <div class="input-icon">
                                ...
                                <select class="form-control" name="currency" id="currency" data-error-container="#error-currency">
                                    ...
                                    <!-- <option>USD</option> -->
                                    <option value="EUR" @if(old('currency', $user->currency) == 'EUR') selected @endif>EUR</option>
                                </select>
                        ...
                        <div class="col-md-4">
                            <div class="input-icon">
                                ...
                                <select class="form-control" name="document" id="document" data-error-container="#error-document">
                                    ...
                                    <option value="id" @if(old('document', $user->document) == 'id') selected @endif>ID</option>
                                </select>
                    ...
                    <div class="form-group{{ $errors->has('document_no') ? ' has-error' : '' }}">
                        ...
                        <div class="col-md-4">
                            <div class="input-icon">
                                ...
                                <input type="text" placeholder="Enter Document No" name="document_no" id="document_no" class="form-control" value="{{old('document_no', $user->document_no)}}" maxlength="15" />
                                @if ($errors->has('document_no'))
                                    <span class="help-block">
                                        <strong>{{ $errors->first('document_no', $user->document_no) }}</strong>
                                    </span>
                                @endif
                            </div>
                        </div>
                    ...
                    <div class="form-group{{ $errors->has('company') ? ' has-error' : '' }}">
                        ...
                        <div class="col-md-4">
                            <div class="input-icon">
                                ...
                                <input type="text" placeholder="Enter Company" name="company" id="company" class="form-control" value="{{old('company', $user->company)}}"/>
    ...
    $('#frmstore').validate({
        ...
        rules: {
            ...
            email: {
                ...
                valid_email: true,
                remote: {
                    url: "{{ route('admin.uniqueemailothers') }}",
                    type: "post",
                    data: {
                        _token: function() {
                            return "{{csrf_token()}}"
