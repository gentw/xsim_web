            ...
            <div class="portlet-body">
                ...
                @php
                    if(empty($user->contact))
                        $user->contact = new App\Models\Contact();
                @endphp

                <form id="frmstore" class="form-horizontal" role="form" method="POST" action="{{ route('admin.user.update', $user->id_user) }}" enctype="multipart/form-data">
                    {{ csrf_field() }}
                    {{ method_field('PUT') }}
                    ...
                    <div class="form-group{{ $errors->has('name') ? ' has-error' : '' }}">
                        ...
                        <div class="col-md-4">
                            <div class="input-icon">
                                <i class="fa fa-user"></i>
                                <input type="text" class="form-control" name="name" id="name" placeholder="Enter User Name" maxlength="50" value="{{ old('name', $user->contact->firstname) }}">
                                @if ($errors->has('name'))
                                    <span class="help-block">
                    ...
                    <div class="form-group{{ $errors->has('surname') ? ' has-error' : '' }}">
                        ...
                        <div class="col-md-4">
                            <div class="input-icon">
                                <i class="fa fa-user"></i>
                                <input type="text" class="form-control" name="surname" id="surname" placeholder="Enter User Name" maxlength="50" value="{{ old('surname', $user->contact->lastname) }}">
                    ...
                    <div class="form-group{{ $errors->has('phone') ? ' has-error' : '' }}">
                        ...
                        <div class="col-md-4">
                            <div class="input-icon">
                                ...
                                <input type="text" placeholder="Enter Contact No" name="phone" id="phone" class="form-control" value="{{old('phone', $user->contact->phone)}}" maxlength="15" />
                                @if ($errors->has('phone'))
                                    <span class="help-block">
                    ...
                    <div class="form-group{{ $errors->has('mobile') ? ' has-error' : '' }}">
                        ...
                        <div class="col-md-4">
                            <div class="input-icon">
                                ...
                                <input type="text" placeholder="Enter Phone No" name="mobile" id="mobile" class="form-control" value="{{old('mobile', $user->contact->mobile)}}" maxlength="15" />
                    ...
                    <div class="form-group{{ $errors->has('dob') ? ' has-error' : '' }}">
                        ...
                        <div class="col-md-4">
                            <div class="input-icon">
                                ...
                                <input type="text" placeholder="Enter Date Of Birth" name="dob" id="dob" class="form-control" value="{{old('dob', date('Y-m-d', strtotime($user->birthsdate)))}}" readonly />
                                @if ($errors->has('dob'))
                                    <span class="help-block">
                    ...
                    <div class="form-group{{ $errors->has('address') ? ' has-error' : '' }}">
                        ...
                        <div class="col-md-4">
                            <div class="input-icon">
                                ...
                                <input type="text" placeholder="Enter Address" name="address" id="address" class="form-control" value="{{old('address', $user->contact->address)}}" />
                    ...
                    <div class="form-group{{ $errors->has('zip_code') ? ' has-error' : '' }}">
                        ...
                        <div class="col-md-4">
                            <div class="input-icon">
                                ...
                                <input type="text" placeholder="Enter Zip Code" name="zip_code" id="zip_code" class="form-control" value="{{old('zip_code', $user->contact->zip)}}" maxlength="15" />
                    ...
                    <div class="form-group{{ $errors->has('city') ? ' has-error' : '' }}">
                        ...
                        <div class="col-md-4">
                            <div class="input-icon">
                                ...
                                <input type="text" placeholder="Enter City" name="city" id="city" class="form-control" value="{{old('city', $user->contact->city)}}" />
                                @if ($errors->has('city'))
                                    <span class="help-block">
                        ...
                        <div class="col-md-4">
                            <div class="input-icon">
                                ...
                                <select class="form-control" name="currency" id="currency" data-error-container="#error-currency">
                                    ...
                                    <!-- <option>USD</option> -->
                                    <option value="EUR" @if(old('currency', $user->contact->currency) == 'EUR') selected @endif>EUR</option>
                                </select>
                        ...
                        <div class="col-md-4">
                            <div class="input-icon">
                                ...
                                <select class="form-control" name="document" id="document" data-error-container="#error-document">
                                    ...
                                    <option value="passport" @if(old('document, $user->contact->document') == 'passport') selected @endif>Passport</option>
                                    <option value="id" @if(old('document', $user->contact->document) == 'id') selected @endif>ID</option>
                                </select>
                    ...
                    <div class="form-group{{ $errors->has('document_no') ? ' has-error' : '' }}">
                        ...
                        <div class="col-md-4">
                            <div class="input-icon">
                                ...
                                <input type="text" placeholder="Enter Document No" name="document_no" id="document_no" class="form-control" value="{{old('document_no', $user->contact->document_no)}}" maxlength="15" />
                    ...
                    <div class="form-group{{ $errors->has('company') ? ' has-error' : '' }}">
                        ...
                        <div class="col-md-4">
                            <div class="input-icon">
                                ...
                                <input type="text" placeholder="Enter Company" name="company" id="company" class="form-control" value="{{old('company', $user->contact->business_name)}}"/>
