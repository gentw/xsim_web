<div id="sidebar-wrapper">
    <div class="user-info">
        <h2>{{ (Auth::guest()) ? "Guest User" : Auth::user()->contact->firstname . " " . Auth::user()->contact->lastname }}</h2>
        <p class="type">Simplified Dashboard</p>
    </div>
    ...
    <ul class="sidebar-menu">
        ...
        <li><a href="{{ route('dashboard.send_sms') }}">Send SMS</a></li>
        {{-- <li><a href="{{ route('dashboard.web_call') }}">Web Call</a></li> --}}
    </ul>
    <ul class="sidebar-bottom-menu">
        <li><a href="{{ route('dashboard.profile', 'simple') }}"><img class="icon" src="{{ asset('dashboard/images/user.png') }}" alt="user"></img> <span>My Account</span></a></li>
        @if(Auth::guest())
